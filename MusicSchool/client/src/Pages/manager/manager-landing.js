...
import { WeekSchedule } from "../staff/staff-landing"

export default class managerLanding extends React.Component{state={
    content:null,
    headers:[],
    loading:true,
    settings: {},
    ...
    return(
        <div className="d-flex flex-column container-fluid ">
            <div className="cardBg">
                ...
                Staff 1 : 27 hours this week
                </div>
                <div className="cardHeader">
                Staff 2 : 27 hours this week
                </div>
                <div className="cardHeader">
                Staff 3 : 27 hours this week
                </div>
            </div>
            <DatapageLayout 
