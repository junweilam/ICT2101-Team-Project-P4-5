...
render(){  
    return(
        ...
        <div className="d-flex flex-column w-100">
                ...
                {this.state.content.data.map((item, index) => {
                    return(
                        <div className="staff-extended"> 
                            <WeekSchedule sid ={item.uid} data = {this.state.jobs}/>
                        </div>
                    ) 
                })}
            </DatapageLayout>
            ...
            <JobModal job={this.state.modalContent} closeModal={this.closeModal}></JobModal>
            }
        </div>
        )
    }
        ...
        return(
            ...
            <div className={"card-bg no-pad"}>
                ...
                <div className="body">
                    ...
                    <WeekView timeField={"jobDate"} maxTimeSlot={6} cellComponent={<EventCell items={this.state.jobs}></EventCell>}></WeekView>
                </div>
